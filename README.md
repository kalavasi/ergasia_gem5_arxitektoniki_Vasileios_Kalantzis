...
**A.** Το [πρόγραμμα](files/number_folder). Tα [αποτελέσματα για minorCPU](files/number_result/Minor_CPU_number) και [αποτελέσματα για TImingSimpleCPU](files/number_result/Minor_CPU_number/Timing_Simple_CPU_number)
