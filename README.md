...
**Α.** Αυτά τα καταλαβαίνουμε από το starter_se.py. Για να επιβεβαιώσουμε τα χαρακτηριστικά του συστήματος και να δούμε επιλογές που μπορεί να μην φαίνονται χρησιμοποιούμε το config.ini και βλέπουμε L2 στο [system.cpu_cluster.l2] και στους πίνακες.  
Επιβεβαιώνουμε ότι το cache_line είναι 64 αλλά επίσης βλέπουμε πληροφορίες όπως μέγεθος size=1048576 , associativity assoc=16. Για την L1 έχουμε για την instruction cache  
...
6. Αλλαγή μόνο DDR3_1600_x64 σε DDR3_2133_x64
...
1. Το κύριο πρόβλημα με τις μνήμες cache είναι τα miss rate τους (ειδικά η L2). Με τα επόμενα 10 πειράματα προσπαθώ να αλλάξω τις μνήμες ώστε να μειώσω
